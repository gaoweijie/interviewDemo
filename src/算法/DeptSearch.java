...
public class DeptSearch {
    public static void main(String args[]) {
        ...
        List<NodeT> visited = new ArrayList<>();
        search.deptFirstSearch(a, visited);
     ...
     * visited 访问过的元素的集合
     */
    void deptFirstSearch(NodeT cur, List<NodeT> visited) {
        ...
        for (int i = 0; i < cur.outgoing.size(); i++) {
            NodeT nextNode = cur.outgoing.get(i).end;
            // 访问本点的结束点
